...
Gradient descent finds the gradient of the cost function of the whole dataset - the gradient direction decreases the fastest and then it updates. Stochastic gradient descent uses smaller samples instead of the whole dataset and then it updates.  
